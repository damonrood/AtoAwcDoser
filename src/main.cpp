...
#include <AsyncElegantOTA.h>
      //https://gitWiFiManagerhub.com/tzapu/WiFiManager
...
int BLUEMOTOR = 33;
int GREENMOTOR = 26;
int YELLOWMOTOR = 12; //12
int PURPLEMOTOR = 13; //13
int LED = 2;
...
//int a = writeDailyDoseAmtToDb("Blue", amt);
//Serial.println("it worked OTA...yea");
